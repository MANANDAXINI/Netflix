    ...
    <div className="home">
      ...
      <img src={hero} alt="" className="relative banner-img " />
        ...
        <div className="herocaption absolute w-[100%] pl-[6%] bottom-0">
            ...
            <p className="max-w-[700px] text-md mb-5 text-white ">Discovering his ties to a secret ancient order, a young man living in modern Istanbul embarks on a quest to save the city from an immortal enemy</p>
